...
- ✅ **ROUND 2 SCRAMBLE SCORING BUG FIXED**: Resolved critical Round 2 scramble net score calculation error. Fixed `getScrambleLeaderboard` function to properly calculate Total Net = Total Gross - Team Handicap instead of incorrectly summing hole-by-hole net scores. API now returns correct values (Team 4: 61 net instead of 46, Team 1: 65 net instead of 50).
